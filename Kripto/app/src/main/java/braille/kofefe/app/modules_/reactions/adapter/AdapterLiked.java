...
public class AdapterLiked extends RecyclerView.Adapter<AdapterLiked.MyViewHolder> {
    ...
    public AdapterLiked(Activity context, List<ModelReactionCommon> mListLiked) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mFollowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mCallback.onFollowerBtnClick("Li",position, mListLiked.get(position), holder.mFollowBtn);
            }
        });
