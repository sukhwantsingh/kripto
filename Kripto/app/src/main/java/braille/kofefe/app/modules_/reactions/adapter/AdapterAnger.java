...
public class AdapterAnger extends RecyclerView.Adapter<AdapterAnger.MyViewHolder> {
    ...
    public AdapterAnger(Activity context, List<ModelReactionCommon> mListLiked) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mFollowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mCallback.onFollowerBtnClick("An",position, mListLiked.get(position), holder.mFollowBtn);
            }
        });
