...
public class AdapterLaugh extends RecyclerView.Adapter<AdapterLaugh.MyViewHolder> {
    ...
    public AdapterLaugh(Activity context, List<ModelReactionCommon> mListLiked) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mFollowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mCallback.onFollowerBtnClick("La",position,  mListLiked.get(position), holder.mFollowBtn);
            }
        });
