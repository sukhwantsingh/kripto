...
public class AdapterFragmentLock extends RecyclerView.Adapter<AdapterFragmentLock.MyViewHolder> {
    ...
    public AdapterFragmentLock(Activity context, List<ModelPostActivityList> mListUnlockInProgress) {
        this.context = context;
        this.uihandle = new UiHandleMethods(context);
        this.mListUnlockInProgress = mListUnlockInProgress;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ModelPostActivityList mData = mListUnlockInProgress.get(position);
        /***
        ...
        holder.mFollowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mCallback.onRelationshipClickLock(mListUnlockInProgress.get(position).getRelationship(),
                        mListUnlockInProgress.get(position), holder.mFollowBtn);
            }
        });
    }
    ...
    public int getItemCount() {
        return mListUnlockInProgress.size();
    }
    ...
    protected class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            mRootLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    StaticValues.mSearechedUserUUID = mListUnlockInProgress.get(getPosition()).getUuid();
