...
public class AdapterSad extends RecyclerView.Adapter<AdapterSad.MyViewHolder> {
    ...
    public AdapterSad(Activity context, List<ModelReactionCommon> mListLiked) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mFollowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mCallback.onFollowerBtnClick("Sa", position, mListLiked.get(position), holder.mFollowBtn);
            }
        });
    }
