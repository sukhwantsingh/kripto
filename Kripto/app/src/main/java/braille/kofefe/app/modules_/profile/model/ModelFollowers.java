...
public class ModelFollowers {
    ...
    public ModelFollowers(String name, String userName, String profilePic, String relationship, String uuid, String bio, String followersCount, String followingCount, String joined, String loc_name, String loc_city, String loc_state, String loc_country) {
        this.name = name;
